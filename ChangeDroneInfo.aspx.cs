    ...
    public partial class ChangeDroneInfo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                droneName.Attributes["placeholder"] = droneID.droneName;
                currentLat.Attributes["placeholder"] = droneID.latitude;
                currentLng.Attributes["placeholder"] = droneID.longitude;
            }
        }
